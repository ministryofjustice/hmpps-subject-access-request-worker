...
class TemplateRenderServiceTest {
  ...
  fun `renderTemplate renders a style template given a service template`() {
    val renderedStyleTemplate = templateRenderService.renderTemplate(null, "test-service", testServiceTemplateData)
  ...
  fun `renderTemplate renders a template given a keyworker template`() {
    val renderedStyleTemplate = templateRenderService.renderTemplate(null, "keyworker-api", testKeyworkerServiceData)
  ...
  fun `renderTemplate renders a template given an activities template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-activities-management-api", testActivitiesServiceData)
  ...
  fun `renderTemplate renders a template given an incentives template`() {
    ...
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-incentives-api", testIncentivesServiceData)
...
//    assertThat(renderedStyleTemplate).contains("Moorland (HMP & YOI)")
  ...
  fun `renderTemplate renders a template given an adjudications template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-manage-adjudications-api", testAdjudicationsServiceData)
  ...
  fun `renderTemplate renders a template given a home detentions curfew template`() {
    val renderedStyleTemplate = templateRenderService.renderTemplate(null, "hmpps-hdc-api", testHDCServiceData)
  ...
  fun `renderTemplate renders a template given a Use of Force template`() {
    ...
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-uof-data-api", testUseOfForceServiceData)
  ...
  fun `renderTemplate renders a template given a prepare someone for release template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-resettlement-passport-api", testResettlementPassportServiceData)
  ...
  fun `renderTemplate renders a template given a court case service template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "court-case-service", testCourtCaseServiceData)
  ...
  fun `renderTemplate renders a template given a accredited programme service template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-accredited-programmes-api", testAccreditedProgrammesServiceData)
  ...
  fun `renderTemplate renders a template given a Non-associations template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-non-associations-api", testNonAssociationsServiceData)
  ...
  fun `renderTemplate renders a template given a Interventions Service template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-interventions-service", testInterventionsServiceData)
  ...
  fun `renderTemplate renders a template given a Categorisation Service template`() {
    val renderedStyleTemplate =
      templateRenderService.renderTemplate(null, "hmpps-offender-categorisation-api", testCategorisationServiceData)
  ...
  fun `renderTemplate returns null if the specified service template does not exist`() {
    assertThat(templateRenderService.renderTemplate(null, "THIS_IS_MADE_UP", testServiceTemplateData)).isNull()
  }
  ...
  fun `renderTemplate throws expected exception when service template is mandated but not template is found`(serviceName: String) {
    val actual = assertThrows<SubjectAccessRequestTemplatingException> {
      templateRenderService.renderTemplate(null, serviceName, testServiceTemplateData)
    }
  }
