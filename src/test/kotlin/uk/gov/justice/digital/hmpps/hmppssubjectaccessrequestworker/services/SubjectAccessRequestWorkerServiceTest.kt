...
class SubjectAccessRequestWorkerServiceTest : IntegrationTestBase() {
  ...
  val configDpsServices = DpsServices(
    dpsServices =
    mutableListOf(
  ...
  inner class GetServiceDetails {
    ...
    private val selectedDpsServices = DpsServices(
      dpsServices =
      mutableListOf(
    ...
    private val configDpsServices = DpsServices(
      dpsServices =
      mutableListOf(
    ...
    fun `getServiceDetails extracts the correct details for the given SAR`() = runTest {
      ...
      Assertions.assertThat(orderedServiceDetails.dpsServices[0].orderPosition).isEqualTo(2)
