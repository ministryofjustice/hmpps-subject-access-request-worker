...
class SubjectAccessRequestWorkerServiceIntTest : IntegrationTestBase() {
  ...
  private fun getPreGeneratedPdfDocument(expectedPdfFilename: String): PdfDocument {
    val inputStream = SubjectAccessRequestWorkerServiceIntTest.javaClass
      .getResourceAsStream("$GENERATED_PDF_BASE_DIR/$expectedPdfFilename")
  ...
  companion object {
    const val GENERATED_PDF_BASE_DIR = "/integration-tests/expected-pdfs"
    ...
    fun testCases() = listOf(
      ...
      TestCase(
        ...
        expectedPdf = "expected-hmpps-offender-categorisation-api.pdf",
      ),
      TestCase(
        ...
        expectedPdf = "expected-hmpps-resettlement-passport-api.pdf",
      ),
    )
  }
