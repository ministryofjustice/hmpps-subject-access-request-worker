...
class TemplateTestingUtil {
  ...
  init {
    whenever(prisonDetailsRepository.findByPrisonId("MDI")).thenReturn(PrisonDetail(
      prisonId = "MDI",
      prisonName = "MOORLAND (HMP & YOI)",
    ))
    whenever(prisonDetailsRepository.findByPrisonId("LEI")).thenReturn(PrisonDetail(
      prisonId = "LEI",
